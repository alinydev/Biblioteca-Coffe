...
<body>
    ...
    <main>
        ...
        <article class="container">
            <b>Bem-vindos ao Projeto Coffee & Literature!</b>
           ...
           <b> Equipe e Divisão de Tarefas</b>
            O projeto foi desenvolvido por três colaboradores, cada um com responsabilidades específicas:
            
            João Lucas: Responsável pelo design das páginas e seu desenvolvimento com HTML e CSS. João garantiu que o site fosse visualmente atraente e fácil de navegar.
            Aliny: Encabeçou a criação do banco de dados, incluindo tabelas e colunas, e a integração do front-end com o back-end utilizando Servlets. O trabalho de Aliny foi crucial para garantir que os dados fossem armazenados e recuperados de forma eficiente.
